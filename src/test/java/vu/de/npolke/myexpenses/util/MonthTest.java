...
public class MonthTest {
	...
	private Month month = create(2015, 5);
	...
	public void nextMonthInNextYear() {
		assertEquals("2016.01", create(2015, 12).next().toString());
	}
	...
	public void previousMonthInPreviousYear() {
		assertEquals("2015.12", create(2016, 1).previous().toString());
	}
	...
	public void equalsEqual() {
		assertTrue(month.equals(create(month.getYear(), month.getMonth())));
	}
	...
	public void compareEqual() {
		assertEquals(0, month.compareTo(create(month.getYear(), month.getMonth())));
	}

	@Test
	public void compareSmallerMonth() {
		assertTrue(month.compareTo(create(month.getYear(), month.getMonth() + 1)) < 0);
	}

	@Test
	public void compareBiggerYear() {
		assertTrue(month.compareTo(create(month.getYear() - 1, month.getMonth())) > 0);
	}
